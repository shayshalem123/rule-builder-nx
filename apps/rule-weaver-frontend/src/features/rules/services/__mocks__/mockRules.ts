...
export const mockRules: RuleWithMeta[] = [
  {
    ...
    permittedActions: [], // Full permissions
  },
  {
    id: '2',
    ...
    createdBy: defaultUser,
    updatedBy: defaultUser,
    permittedActions: ['read', 'write'], // Read-write only
  },
  {
    id: '3',
    ...
    createdBy: defaultUser,
    updatedBy: defaultUser,
    permittedActions: ['read'], // Read-only
  },
  {
    id: '4',
  ...
  },
  {
    ...
    createdBy: defaultUser,
    updatedBy: defaultUser,
    permittedActions: ['read', 'write', 'delete'], // Full permissions
  },
  ...
  },
  {
    ...
    createdBy: defaultUser,
    updatedBy: defaultUser,
    permittedActions: ['read'], // Read-only for compliance
  },
  {
    id: '13',
  ...
  // New Destination D rules
  {
    ...
    createdBy: defaultUser,
    updatedBy: defaultUser,
    permittedActions: ['read'], // Read-only for real-time data
  },
  {
    id: '16',
